...
const menuItems = [
  { name: "Dashboard", href: "/insurance/dashboard", icon: LayoutDashboard },
  { name: "Statistics", href: "/insurance/statistics", icon: BarChart2 },
  { name: "Pharmacies", href: "/insurance/pharmacies", icon: Shield },
  { name: "Affiliates", href: "/insurance/affiliates", icon: Users },
  { name: "Appeals", href: "/insurance/appeals", icon: FileText },
];
      ...
      <div className="h-screen w-64 bg-white shadow-lg flex flex-col justify-between font-sans">
        ...
        <div className="space-y-2 py-6">
          ...
          <div className="relative">
            {pathname === "/insurance/account" && (
              <div className="absolute left-0 top-0 h-full w-1.5 bg-blue-600 rounded-r-full"></div>
            )}
            <Link
              href="/insurance/account"
              className={`flex items-center gap-3 py-3 rounded-lg font-medium transition-all duration-200 ease-in-out mx-4 px-4 ${
                pathname === "/insurance/account"
                  ? "bg-blue-500 text-white shadow-lg shadow-blue-500/30"
                  : "text-gray-500 hover:bg-gray-100 hover:text-gray-900"
