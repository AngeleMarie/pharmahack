      ...
      <div className="max-w-7xl mx-auto">
        <div className="space-y-8 mx-2 sm:mx-4 md:mx-0">
          ...
          <div className="relative my-8 md:my-12">
            <div className="bg-white border-2 p-1 flex mx-auto md:mx-auto text-xs sm:text-sm text-center border-[#EEEEEE] shadow-xl m-4 sm:m-6 rounded-md w-full sm:w-2/3 md:w-1/3">
